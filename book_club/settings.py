...
TEMPLATES_DIR = os.path.join(BASE_DIR, 'book_club', 'templates')
...
ALLOWED_HOSTS = [
    '8000-goca7-bookclubfullstac-rg7r7tapfxq.ws.codeinstitute-ide.net',
    '.herokuapp.com'
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'book_club', 'static')]
